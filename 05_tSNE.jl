...
# ╔═╡ 4a665204-3ba9-4866-8dac-bebbdd59886e
begin
fig = scatter(tsne_result[:,1],tsne_result[:,2], color = map(x->cols[x],df_clustered.cell_type), markersize = 2)
	save(joinpath(@__DIR__,"plots","05_celltype_tsne.png"),fig)
	fig
end

# ╔═╡ 5c17738a-6f74-41e9-9c7e-5d5fbec62216
cols
...
manifest_format = "2.0"
project_hash = "fe20ca18df1f0423dd8fca06ee08cfc93a593b4e"
