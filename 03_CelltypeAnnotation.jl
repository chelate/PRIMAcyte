...
clusteron = vcat(setdiff(names(df)[findfirst(==("Vimentin"), names(df)):end],
	["CD39","HistH3","Ir-193","Ir-191"])) # dont cluster on these

# ╔═╡ ccbc0bd6-3cf0-48d5-a35e-885606e7f2e8
begin
	g = Figure(size = (500,2500))
...
git-tree-sha1 = "286c62e771b8945d0a828129b83caa38ec4ad5ad"
